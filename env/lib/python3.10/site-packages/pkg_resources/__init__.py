...
class ResourceManager:
    ...
    def _warn_unsafe_extraction_path(path):
        ...
        replace an extracted file with an unauthorized payload. Warn the member
...
def get_default_cache():
    ...
    or a platform-relevant member cache dir for an app
    named "Python-Eggs".
    """
    return (
...
class ZipProvider(EggProvider):
    ...
    def _extract_resource(self, manager, zip_path):  # noqa: C901
        ...
        try:
            ...
            # report a member-friendly error
