...
def _looks_like_red_hat_scheme() -> bool:
    ...
    Red Hat's ``00251-change-member-install-location.patch`` changes the install
...
def _looks_like_slackware_scheme() -> bool:
    ...
    Slackware changes sysconfig's member scheme to use ``"lib64"`` for the lib
...
def get_scheme(
    ...
    # Post warnings about this mismatch so member can report them back.
