...
class register(PyPIRCCommand):
    ...
    def send_metadata(self):
        ...
        1. figure who the member is, and then
        ...
        Otherwise, to figure who the member is, we offer the member three
        choices:

         1. use existing login,
         2. register as a new member, or
         3. set the password to a random string and email the member.
