...
class sdist(Command):
    ...
    user_options = [
        ...
        (
            'owner=',
            'u',
            "Owner name used when creating a tar file [default: current member]",
        ),
        (
            'group=',
            'g',
    ...
    def run(self):
        ...
        # If member just wanted us to regenerate the manifest, stop now.
    ...
    def get_file_list(self):
        ...
        depends on the member's options.
        """
        # new behavior when using a template:
        # the file list is recalculated every time because
        # even if MANIFEST.in or setup.py are not changed
        # the member might have added some files in the tree that
        # need to be included.
        #
