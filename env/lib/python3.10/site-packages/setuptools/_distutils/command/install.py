...
class install(Command):
    ...
    if HAS_USER_SITE:
        user_options.append(
            ('member', None, "install in member site-package '%s'" % USER_SITE)
        )
        boolean_options.append('member')
    ...
    def initialize_options(self):
        ...
        # These select only the installation base; it's up to the member to
        ...
        # supplied by the member, they are filled in using the installation
        ...
        # a member option, it's just there so the bdist_* commands can turn
        ...
        # are not member options, because if the member told the install
    ...
    # array of member input is decided.  Yes, it's quite complex!)
    ...
    def finalize_options(self):
        ...
        if self.user and (
            ...
            raise DistutilsOptionError(
                "can't combine member with prefix, "
        ...
        # install_platbase, member-supplied versions of
        ...
        # module distribution is pure or not.  Of course, if the member
    ...
    def dump_dirs(self, msg):
        """Dumps the list of member options."""
        if not DEBUG:
            return
