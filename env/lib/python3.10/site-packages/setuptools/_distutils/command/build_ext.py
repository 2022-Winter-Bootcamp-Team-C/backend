...
class build_ext(Command):
    ...
    user_options = [
        ...
        ('member', None, "add member include, library and rpath"),
    ]

    boolean_options = ['inplace', 'debug', 'force', 'swig-cpp', 'member']
    ...
    def finalize_options(self):
        ...
        # Finally add the member include and library directories if requested
        if self.user:
