...
class AutoSchema(ViewInspector):
    ...
    def __init__(self, tags=None, operation_id_base=None, component_name=None):
        """
        :param operation_id_base: member-defined name in operationId. If empty, it will be deducted from the Model/Serializer/View name.
        :param component_name: member-defined component's name. If empty, it will be deducted from the Serializer's class name.
        """
    ...
    def get_tags(self, path, method):
        # If member have specified tags, use them.
        if self._tags:
            return self._tags

        # First element of a specific path could be valid tag. This is a fallback solution.
        # PUT, PATCH, GET(Retrieve), DELETE:        /user_profile/{id}/       tags = [member-profile]
        # POST, GET(List):                          /user_profile/            tags = [member-profile]
        if path.startswith('/'):
            path = path[1:]
