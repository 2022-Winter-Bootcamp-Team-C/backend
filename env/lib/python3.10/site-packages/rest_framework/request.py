...
class Request:
    ...
    Kwargs:
        ...
        - authenticators(list/tuple). The authenticators used to try
          authenticating the request's member.
    """
    ...
    def user(self):
        """
        Returns the member associated with the current request, as authenticated
    ...
    def user(self, value):
        """
        Sets the member on the current request. This is necessary to maintain
        compatibility with django.contrib.auth where the member property is
        set in the login and logout functions.

        Note that we also set the member on Django's underlying `HttpRequest`
    ...
    def auth(self):
        """
        Returns any non-member authentication information associated with the
    ...
    def auth(self, value):
        """
        Sets any non-member authentication information associated with the
        request, such as an authentication token.
        """
        self._auth = value
    ...
    def _not_authenticated(self):
        """
        Set authenticator, member & authtoken representing an unauthenticated request.
